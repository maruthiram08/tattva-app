...
4. Offer 2-3 alternative questions that ARE in scope
...

{
  ...
  "why": "Explain why this question type is not answered (e.g., requires modern judgment, cross-text comparison, etc.). Be educational, not defensive. 2-3 sentences.",
  "whatICanHelpWith": [
    "Alternative question 1 that IS in scope",
    "Alternative question 2 that IS in scope",
    "Alternative question 3 that IS in scope (optional)"
  ]
}
...
- [ ] 2-3 substantive alternative questions provided
- [ ] Alternatives are genuinely in scope (not vague)
